...
class _ChatPageState extends State<ChatPage> with TickerProviderStateMixin{
      ...
      appBar: AppBar(
        ...
        title: Column(
          children: <Widget>[
            ...
            Text(usuarioPara.nombre, style: TextStyle( color: Colors.black87, fontSize: 15 ),)
          ...
          children: <Widget>[
           ...
           Flexible(
             child: TextField(
               ...
               onChanged: ( texto ){
              // al escribir cuando hay un valor para poder enviar mensaje
                setState(() {
  ...
  void dispose() {
   ...
   for( ChatMessage message in _messages ){
    ...
    // cuando nos salgamos del chat con esto dejara de escuchar si queremos que siempre
    // escuche quitarlo 
